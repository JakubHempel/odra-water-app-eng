...
st.markdown(
    ...
    ***OdrApp*** to aplikacja służąca do monitoringu jakości wody w rzece Odra. Przedstawia ona wieloczasową analiza jakości wody z wykorzystaniem zobrazowań satelitarnych i Google Earth Engine. Obejmuje okres od 2018 do teraz, od kwietnia do października.
    ...
    1. Przejdź do strony [Indexes](https://odra-water-app.streamlit.app/Indexes) i dowiedz się więcej o indekach spektralnych użytych w analizie.
    ...
    **Kolejność dowolna! Na start, pamiętaj o przeczytaniu o indeksach spektralnych na stronie [Indexes](https://odra-water-app.streamlit.app/Indexes).**
